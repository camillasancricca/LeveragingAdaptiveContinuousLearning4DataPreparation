...
class SimulationEnvironmentKBImpact:
    def __init__(self, percentage_usage_data, num_interactions_in_kb, alpha, seed):
        ...
        self.train_dataset, self.test_data, self.transactions_in_kb = create_traintest_split_with_knowledge_KBTrainingImpact(percentage_usage_data,
